...
export default function InptDateEditable({element, tabName, style, xDeletions, bindingsLabel }: TypeEditable){
    ...
    {isEditing ? (
        ...
        {bindingsLabel}
        {xDeletions}
        <InptDate title={element.title} id={id} placeholder={element.placeholder} disabled={element.disabled}/></>
    )}
</div>
}
